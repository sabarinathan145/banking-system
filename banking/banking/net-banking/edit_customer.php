...
<body>
    <form class="add_customer_form" action="./edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="kathmandu" <?php if ($branch == 'Madurai') {?> selected="selected" <?php }?>>Madurai</option>
                    <option value="delhi" <?php if ($branch == 'Chennai') {?> selected="selected" <?php }?>>Chennai</option>
                    <option value="newyork" <?php if ($branch == 'Coimbature') {?> selected="selected" <?php }?>>Coimbature</option>
                    <option value="paris" <?php if ($branch == 'Sivaganga') {?> selected="selected" <?php }?>>Sivaganga</option>
                    <option value="riyadh" <?php if ($branch == 'Erode') {?> selected="selected" <?php }?>>Erode</option>
                    <option value="moscow" <?php if ($branch == 'Trichy') {?> selected="selected" <?php }?>>Trichy</option>
                </select>
            </div>
        </div>
